...
$phone='905399977748'
$payload=@{ phone=$phone; message='14 ağustos ile 18 ağustos tarihler arasında 2 yetişkin fiyatı nedir'; message_id=('single-'+[guid]::NewGuid().ToString()) } | ConvertTo-Json -Compress
